...
foreach($files as $fileIndex => $file)
{
    ...
    while (($data = fgetcsv($open, 0, ";")) !== FALSE)
    {
        ...
        //
        if (file_exists("./bus/o00452-{$nubu}{$zn}{$se}.imgbu"))
        {
            echo "Já processado!\n";
            continue;
        }
         ...
         *
         */
        $url = "https://resultados.tse.jus.br/oficial/ele2024/arquivo-urna/452/dados/{$uf}/{$nubu}/{$zn}/{$se}/p000452-{$uf}-m{$nubu}-z{$zn}-s{$se}-aux.json";
         ...
         *
         */
        $urlBu = "https://resultados.tse.jus.br/oficial/ele2024/arquivo-urna/452/dados/{$uf}/{$nubu}/{$zn}/{$se}/{$hash}/o00452{$uf}{$nubu}{$zn}{$se}-bu.dat";
        ...
        // salva
        file_put_contents("./bus/o00452-{$nubu}{$zn}{$se}.imgbu", $result);
